...
проти Vernasca Black за VIN). Це дає змогу відсіяти cognac / айворі / червоний
...
TRIM_COLOURS = {
    ...
    'ivory':   ('Ivory White (айворі)', False),
    'beige':   ('бежевий / айворі',     False),
    'red':     ('червоний',             False),
    'coffee':  ('коричневий / Coffee',  True),
    'black':   ('чорний',               True),
